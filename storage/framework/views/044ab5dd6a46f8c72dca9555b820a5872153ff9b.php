<div class="contact">
            <div class="container">
                ...
                <div class="row contact-form">
                    ...
                    <div class="col-md-6">
                        <div id="success"></div>
                        <form action="<?php echo e(url('query')); ?>" method="post" enctype="multipart/form-data" novalidate="novalidate">
                            <?php echo csrf_field(); ?>
        ...
        <!-- Contact End -->
<?php /**PATH E:\totorial\bruger\resources\views/user/startcontact.blade.php ENDPATH**/ ?>