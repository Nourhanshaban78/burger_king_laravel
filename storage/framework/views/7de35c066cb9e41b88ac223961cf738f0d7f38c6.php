  ...
  <div class="booking">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="booking-form">
                            ...
                            <form action="<?php echo e(url('guest')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
        ...
        <!-- Booking End --><?php /**PATH E:\totorial\bruger\resources\views/user/table.blade.php ENDPATH**/ ?>