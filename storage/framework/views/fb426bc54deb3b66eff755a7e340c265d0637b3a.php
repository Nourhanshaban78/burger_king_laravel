            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        <a href="<?php echo e(url('/home')); ?>" class="nav-item nav-link">Home</a>
                        <a href="<?php echo e(url('/about')); ?>" class="nav-item nav-link">About</a>
                        <a href="<?php echo e(url('/feature')); ?>" class="nav-item nav-link active">Feature</a>
...
<?php /**PATH E:\totorial\bruger\resources\views/user/feature.blade.php ENDPATH**/ ?>